...
import { useExperimentalSettings } from '~/hooks/secret-features'
...
export default function SettingsSheet() {
  ...
  // Hidden until the 7-tap gesture in Settings → Tentang. The feature is
  // unfinished (rail only), so it is not something to stumble into.
  const showExperimental = useExperimentalSettings()
